...
(function (pxsim) {
    ...
    (function (PiCode) {
        ...
        function forwardFieldAsync() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, pxsim.board().move(51)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        PiCode.backwardFieldAsync = backwardFieldAsync;
        /**
         * Girar para a direita
         */
        //% weight=99
        //% blockId=turtleTurnRightField block="Girar para a direita"
        function turnRightFieldAsync() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, pxsim.board().turn(90)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        PiCode.turnRightFieldAsync = turnRightFieldAsync;
        /**
         * Girar para a esquerda
         */
        //% weight=99
        //% blockId=turtleTurnLeftField block="Girar para a esquerda"
        function turnLeftFieldAsync() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, pxsim.board().turn(-90)];
        ...
        PiCode.turnLeftFieldAsync = turnLeftFieldAsync;
        /**
         * Girar 45 para a direita
         */
        //% weight=98
        //% blockId=turtleTurnHalfRightField block="Girar 45 para a direita"
        function turnHalfRightFieldAsync() {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, pxsim.board().turn(45)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        PiCode.turnHalfLeftFieldAsync = turnHalfLeftFieldAsync;
        // /**
        ...
        // }
    })(PiCode = pxsim.PiCode || (pxsim.PiCode = {}));
})(pxsim || (pxsim = {}));
(function (pxsim) {
    var time;
    (function (time) {
...
(function (pxsim) {
    ...
    var TurtleBoard = /** @class */ (function (_super) {
        ...
        function TurtleBoard() {
            ...
            _this.image = new createjs.Bitmap("mapa.png");
        ...
        TurtleBoard.prototype.move = function (distance) {
            ...
            if (this.pen || this.turtleSprite.visible) {
                ...
                this.turtleToFront();
                if (this.delay > 0) {
                    var cmd_1 = g.lineTo(this.xOffset + x, this.yOffset - y)
                        .command;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, loadImages("picode.png", "picode.png", "picode.png")];
                    case 1:
    ...
    function loadImages() {
        ...
        return new Promise(function (resolve, reject) {
            ...
            queue.addEventListener("complete", function () {
                resolve(queue
                    .getItems(true)
                    .map(function (i) { return new createjs.Bitmap(i.result); }));
            });
        });
    }
})(pxsim || (pxsim = {}));
